...
/* Fix: hide any raw text nodes that look like keyboard_ icons */
[data-testid="stExpander"] summary [data-testid="stMarkdownContainer"] > p:empty,
button[kind="header"] > div > p { display:none !important; }
/* Hide material icon text that leaks */
.material-symbols-rounded, [class*="material-icon"] { display:none !important; }
