...
# ═══════════════════════════════════════════════════════
    ...
    # ── AGENDA ──
        ...
        # Seleciona automaticamente o dia atual; se não tiver na agenda, o primeiro disponível
        _hoje_ds  = ["Segunda","Terça","Quarta","Quinta","Sexta","Sábado","Domingo"][today_br().weekday()]
        _def_idx  = dias_present.index(_hoje_ds) if _hoje_ds in dias_present else 0
        dia_sel   = st.selectbox("Selecione o dia", dias_present, index=_def_idx)
