...
with st.sidebar:
    ...
    if is_superadmin:
        ...
        # ── Botão criar teste.teste — aparece SEMPRE (qualquer modo) ──
        ...
        if not _teste_existe:
            ...
            st.markdown(
                "<div style='background:#1a1400;border:1px solid #f59e0b33;"
                "border-radius:8px;padding:6px 10px;font-size:11px;"
                "color:#f59e0b;margin-top:4px;text-align:center'>"
                    ...
                    for _, _rp2 in prods.iterrows():
                        ...
                        db_exec(
                            ...
                            (_data_hoje, usuario, merc, _prod_nm, _st_prod, _fp2,
                             _pf_prod, _fb64_prod, _hora_agora, 0, 0,
