    ...
    if is_superadmin:
        ...
        if modo_atual == "funcionario":
            ...
            if not _teste_existe:
                ...
                st.markdown("<div style='color:#444;font-size:10px;padding:4px 0'>"
                            "🧪 teste.teste ativo</div>", unsafe_allow_html=True)
